...
mysql_query("INSERT INTO cj_cp_institutos(id_ninho,cedula_mp,cedula_pm) value('$id_ninho','$mp','$pm')")or die (mysql_error());
$contador=$contador+1;
mysql_query("UPDATE contador_insti SET contador='$contador' WHERE con_i='0'",$con) or die (mysql_error());
...
header("location: ../institutos/nino.php?nino=$id_ninho&&msj=1");
