...
<body onclick='g();'>
	...
	<div id="contenedor">
		<h3 class="n">Ingreso del Beneficiario<br>Cédula del Representante</h3><br>
		<form action="../ingresar/re_mp_insti.php" method="get" id="ing_mp" onsubmit="return validar(this)" onkeypress="return permite(event, 'num_car')">
