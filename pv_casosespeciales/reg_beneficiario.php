...
<body>
	...
	<div id="contenedor">
		...
		<form action="ing_beneficiario.php" method="get" id="ing_mp">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cédula <input type="text" name="mp" id="mp" autocomplete=off onkeyup="busc_ms();bus_h()" >
		<input type="submit" value="Enviar">
		<div id="suggestions"></div>
		</form><br>
		<center><span><a href="index.php" >Cancelar</a></span></center><br>
	</div>
	<script>
