...
<body onclick='g();'>
	...
	<div id="contenedor">
		<h3 class="n">Ingreso del Beneficiario (Casos Especiales)<br>Datos del Representante y los Padres</h3><br>
		<?php
		...
		<?php
			...
			if($row_madpad3['trb_cedula']=="" and $mp_nr_row2['mp_cedula']==""){
				...
				echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;V.- $pm - Nombre <input class='tamanio_le' type='text' name='mp0' id='mp0' autocomplete=off> Apellido <input class='tamanio_le' type='text' name='mp1' id='mp1' autocomplete=off>";
