...
<head>
	...
	function validarced(formulario){
...
<body onclick='g();'>
	...
	<div id="contenedor">
		<h3 class="n">Ingreso del Beneficiario (Casos Especiales)<br>Cédula de la madre o el padre</h3><br>
		<?php
		...
		<?php
		if($row_madpad2['trb_cedula']=="" and $mp_nr_row['mp_cedula']==""){
				echo "<form action='re_pm2.php' method='get' id='ing_mp'  onsubmit='return validar(this)'>";
				...
				echo "<center><input type='submit' value='Siguiente'></center>
				</form><br>";
				echo "<center><span style='font-weight:bold'><a href='re_mp.php?re=$re'>Atras</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='./' >Cancelar</a></span></center><br>
				";
			}
		if($row_madpad['trb_cedula']!="" and $row_madpad2['trb_cedula']!=""){
			echo "<form action='re_pm3.php' method='get' id='ing_mp' onsubmit='return validarced(this)'>";
			echo "<input type='hidden' name='re' value='".$re."'>";
			echo "<input type='hidden' name='mp' value='".$mp."'>";
			echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cédula <input type='text' name='pm' id='mp' autocomplete=off onkeyup='busc_ms();bus_h()' onkeypress=\"return permite(event, 'num_car')\"><input type='submit' value='Enviar'>";
			echo "<div id='suggestions'></div></form><br>
			<center><span style='font-weight:bold'><a href='ingresar_nino_rep.php?re=$re&&mp=$mp' >Omitir</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='re_mp.php?re=$re'>Atras</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='./' >Cancelar</a></span></center><br>
			<script>
...
<!--
		<?php echo "<center><span style='font-weight:bold'><a href='re_mp.php?re=$re'>Atras</a>";
		?>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='../' >Cancelar</a></span></center><br>
-->
	</div>
