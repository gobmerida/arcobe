...
include("../script_php/a_fe.php");
		include("../script_php/condicion.php");
			if(array_key_exists('pn',$_GET)){
				$n_planilla = $_GET['pn'];
				$pv_planilla_ceConsulta = "SELECT pv_planillace.*,pvce_mpr.*,cp_gsanguineos.*,pv_destinos.pv_destino as destino,
...
<body>
	...
	?>
	<a href='pv_ceotro.php?pn=<?php echo $_GET['pn']; ?>'><img src="../media/editar.png" width="50px"></a><br>
	<?php
	}
	?>
	</div>
	<div id="pv_planilla">
		<table>
			<?php
				echo "
				<tr><td colspan=2 class='planilla'>Número de planilla: $pv_planilla_ce[pv_planillanumero]</td><td colspan=2 class='planilla'>Código del Responsable: $pv_planilla_ce[codigo_trb]</td></tr>
				...
				<tr><td colspan=4 class='planilla sub_titulo'><b><u>DATOS DEL RESPONSABLE</u></b></td></tr>
				<tr><td colspan=4 class='planilla'><b>Cédula: </b>$pv_planilla_ce[mpr_cedula]</td></tr>
				<tr><td colspan=4 class='planilla'><b>Nombres: </b>$pv_planilla_ce[mpr_nombres]</td></tr>
				<tr><td colspan=4 class='planilla'><b>Apellidos: </b>$pv_planilla_ce[mpr_apellidos]</td></tr>
				<tr><td colspan=2 class='planilla'><b>Dirección Actual: </b>$pv_planilla_ce[mpr_direccion]</td><td class='planilla'><b>Teléfono:</b> $pv_planilla_ce[mpr_telefono]</td><td class='planilla'><b>Estatus/Condición:</b><br>$condicion</td></tr>
		...
		<table style="border:1px solid white">
			<tr>
				<td class='info-planilla'>
					<h4 align="center"><u>REPRESENTANTE</u></h4>
					<p style="text-align:justify; margin:20px">&nbsp;&nbsp;&nbsp;&nbsp; Yo, <b><?php echo "$pv_planilla_ce[mpr_nombres] $pv_planilla_ce[mpr_apellidos]";?></b>, 
					portador de la Cédula de Identidad número: <b><?php echo "$pv_planilla_ce[mpr_cedula]";?></b>, residenciado en: <?php echo "$pv_planilla_ce[mpr_direccion]";?>
					...
					que los datos suministrados por mi son fehacientes.<br>
						...
						<center><b style="text-decoration:overline">Firma del Representante</b></center>
					</p>
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			...
			<tr>
				<td>
					<table style="width:100%;border" class="conforme-rep">
						<tr>
							<td colspan="2"><b>Código del responsable: </b><?php echo "$pv_planilla_ce[codigo_trb]";?></td><td colspan="2"><b>Número de Planilla: </b><?php echo "$pv_planilla_ce[pv_planillanumero]";?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<b>C.I. </b><?php echo "$pv_planilla_ce[mpr_cedula]";?><br>
							<b>Nombres: </b><?php echo "$pv_planilla_ce[mpr_nombres] $pv_planilla_ce[mpr_apellidos]";?><br>
							<b>Dirección: </b><?php echo "$pv_planilla_ce[mpr_direccion]";?>
							</td>
						</tr>
						<tr>
