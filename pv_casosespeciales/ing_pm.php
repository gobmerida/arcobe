...
<body onclick='g();'>
	...
	<div id="contenedor">
		...
		if(array_key_exists("mp",$_GET)){
			...
			echo "<table><tr><td>V.- ".$row_madpad['trb_cedula']."</td><td> - ".$row_madpad['trb_nombres']."</td><td>".$row_madpad['trb_apellidos']."</td></tr></table>";
					...
					if($row_hijos['id_nino']!=""){
						...
						echo "<span class='cen'><a href='./pv_nino_ce.php?nino=$cod_nino' class='nino' target='_blank' style='color:SteelBlue'>$e_nino</a></span><br>";
						$i=$i+1;
					}
					}
		...
		?>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cédula <input type="text" name="pm" id="mp" autocomplete=off  onkeyup="busc_ms();bus_h()" onkeypress="return permite(event, 'num')"><input type="submit" value="Enviar">
