function validar_periodo(formulario){
	...
	if(formulario.com_periodo.value.length!=0 && formulario.fin_periodo.value.length!=0 && formulario.fecha_limite.value.length!=0){
...
function OcErrorFeL(){
	...
	if(i > l){
		...
		edad = edad+" años";
		document.getElementById("edad_lm").value=edad;
		document.getElementById("f_sub").disabled=false;
	}
}
