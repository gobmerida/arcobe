<span style='color:red;font-weight:bold'>Buscar por fecha de nacimiento y apellido</span>
<?php
...
while($DataROW00 = mysql_fetch_array($DataSQl00)){
	...
	if($DataNRaux!=$DataNR){
		$DataSQl01 = "select * from cj_hijos where h_fecha_naci='$DataROW00[h_fecha_naci]' and id_ninho!='$DataROW00[id_ninho]' and h_apellido1='$DataROW00[h_apellido1]'";
