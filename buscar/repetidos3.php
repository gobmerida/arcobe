<span style='color:red;font-weight:bold'>Buscar por fecha de nacimiento</span>
<?php
...
while($DataROW00 = mysql_fetch_array($DataSQl00)){
	$DataNRaux = $DataROW00["h_fecha_naci"];
	if($DataNRaux!=$DataNR){
		$DataSQl01 = "select * from cj_hijos where h_fecha_naci='$DataNRaux' and id_ninho!='$DataROW00[id_ninho]'";
