	...
	if($DataROW00["activo"]==1){
		...
		while($DataROW01 = mysql_fetch_array($DataSQl01)){
			...
			if($edad<=12){
				...
				$DataSQL03 = "SELECT * FROM cj_inscritos_periodo WHERE id_ninho='$DataROW01[id_ninho]' and id_periodo='2'";
				...
				if($DataROW01["id_ninho"]==$DataROW03["id_ninho"]){
					...
					$i++;
					$aux1++;
					$DataSQL04 = "INSERT INTO cj_inscritos_periodo(id_ninho, id_periodo) VALUES('$DataROW01[id_ninho]','2') ";
		...
		while($DataROW08 = mysql_fetch_array($DataSQl07)){
			...
			if($edad<=12){
				...
				$DataSQL09 = "SELECT * FROM cj_inscritos_periodo WHERE id_ninho='$DataROW08[id_ninho]' and id_periodo='2'";
				...
				if($DataROW08["id_ninho"]==$DataROW09["id_ninho"]){
					...
					$i++;
					$aux1++;
					$DataSQL04 = "INSERT INTO cj_inscritos_periodo(id_ninho, id_periodo) VALUES('$DataROW08[id_ninho]','2') ";
					$DataSQL04 = mysql_query($DataSQL04);
				}
			}
		}
