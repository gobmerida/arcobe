...
$search = $_POST['codigo'];
if($search!=""){
$query_services = mysql_query("SELECT * FROM cj_hijos WHERE id_ninho like '" . $search . "%' ORDER BY id_ninho DESC", $con);
$co=0;
...
if($co==0){
$b_nombre = mysql_query("SELECT * FROM cj_hijos WHERE h_nombre1 like '" . $search . "%' ORDER BY id_ninho DESC", $con);
$nu=0;
...
if($nu==0){
$b_apellido = mysql_query("SELECT * FROM cj_hijos WHERE h_apellido1 like '" . $search . "%' ORDER BY id_ninho DESC", $con);
$ni=0;
...
if($ni==0){
$b_apellido_nombre = mysql_query("SELECT * FROM b_nino_na WHERE nombre_com like '" . $search . "%' ORDER BY id_ninho DESC", $con);
$ne=0;
