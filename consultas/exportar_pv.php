...
while( $DataROW00 = mysql_fetch_array($DataSQL00) ){
	$DataSQL01 = "select cj_hijos.*
				  ...
				  where pv_inscrip.id_periodo='$data01' and cedula_mp='".$DataROW00["trb_cedula"]."' OR cedula_repr='".$DataROW00["trb_cedula"]."'";
...
header('Content-Disposition: attachment; filename="CuadernoPlanVacacional.xlsx"');
