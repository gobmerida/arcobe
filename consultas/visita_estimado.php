...
<body>
	...
	$consulta_reg = "SELECT * FROM pv_inscrip
					...
					WHERE id_periodo='$periodo' and pv_destino='2'";
	...
	<div id="resumen">
		...
		if($cperiodo['cierre']=="0"){
			echo "<h3>Estimados para Visita Guiada</h3>";
		}
		if($cperiodo['cierre']=="1"){
			echo "<h3>Reporte para Visita Guiada</h3>";
		}
		$total_emp=$empfijo+$empcont;
		$total_obr=$obrfijo+$obrcont;
		$total=$empfijo+$empcont+$obrfijo+$obrcont;
		
			echo "<a href='ConsultaNinosPV.php?tipo=VISITA GUIADA&anp=$anio_periodo'>Exportar</a>
